...
import { getTaskStageSchema, createTaskStageSchema, updateTaskStageSchema, deleteTaskStageSchema } from "../schemas/taskStageSchema.js";
...
taskStageRouter.get("/get-one/:id", schemaValidator(getTaskStageSchema, "params"), async (req, res) => {
    try {
        const { id } = req.params;
...
taskStageRouter.post("/create-one", schemaValidator(createTaskStageSchema, "body"), async (req, res) => {
    try {
...
taskStageRouter.patch("/update-one", schemaValidator(updateTaskStageSchema, "body"), async (req, res) => {
    try {
        const { id } = req.params;
...
taskStageRouter.delete("/delete-one/:id", schemaValidator(deleteTaskStageSchema, "params"), async (req, res) => {
    try {
        const { id } = req.params;
